...
const xii = document.querySelector('.xii');
const multimediaSatu = document.querySelector('.multimedia-satu');
...
window.onload = () => {
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            xii.classList.toggle('x-nol');
            xii.classList.toggle('opasiti-satu');
            multimediaSatu.classList.toggle('y-nol');
            multimediaSatu.classList.toggle('opasiti-satu');
